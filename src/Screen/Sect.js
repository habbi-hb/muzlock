...
export class Sect extends Component {
  constructor() {
    super();
    this.state = {
      selected: '',
      ...
      <View style={{flex: 1, backgroundColor: 'white'}}>
        ...
        <View style={{height: '7%', width: '100%', alignItems: 'center'}}>
          <TouchableOpacity
            style={{
              borderRadius: 25,
              borderWidth: selected == 'Sunni' ? 1.5 : 0,
              borderColor: 'red',
            }}
            onPress={() => {
              this.setState({selected: 'Sunni'});
              setTimeout(
        ...
        <View style={{height: '7%', width: '100%', alignItems: 'center'}}>
          <TouchableOpacity
            style={{
              borderRadius: 25,
              borderWidth: selected == 'Shia' ? 1.5 : 0,
              borderColor: 'red',
            }}
            onPress={() => {
              this.setState({selected: 'Shia'});
              setTimeout(
                () => this.props.navigation.navigate('Languages'),
                2000,
              );
        ...
        <View style={{height: '7%', width: '100%', alignItems: 'center'}}>
          <TouchableOpacity
            style={{
              borderRadius: 25,
              borderWidth: selected == 'Other' ? 1.5 : 0,
              borderColor: 'red',
            }}
            onPress={() => {
